...
training_args = TrainingArguments(
    output_dir="./output/PKU-Alignment/PKU-SafeRLHF-10K/modpo/rm/kiwi",
    overwrite_output_dir=True,
    seed=42,
    ...
    fp16=True,
    remove_unused_columns=False,
    run_name="PKU-Alignment/PKU-SafeRLHF-10K/modpo/rm/kiwi",
    report_to="wandb",
...
sft_model = AutoModelForCausalLM.from_pretrained(
    ...
    torch_dtype=torch.float16, # necessary for llama2, otherwise will be cast to float32
