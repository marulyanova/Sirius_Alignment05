...
training_args = TrainingArguments(
    output_dir="./output/PKU-Alignment/PKU-SafeRLHF-10K/modpo/lm/0.3xcomet+0.3kiwi+0.3fluency",
    overwrite_output_dir=True,
    seed=42,
    ...
    fp16=True,
    remove_unused_columns=False,
    run_name="PKU-Alignment/PKU-SafeRLHF-10K/modpo/lm/0.3xcomet+0.3kiwi+0.3fluency",
    report_to="wandb",
