...
def main():
    ...
    os.environ['RANK'] = '0'  # Установите уникальный ранг для этого процесса
    os.environ['WORLD_SIZE'] = '1'  # Установите общее количество процессов
    os.environ['MASTER_ADDR'] = 'localhost' # или IP-адрес вашей машины
    os.environ['MASTER_PORT'] = '12345' # любой свободный 
    ...
    # Preprocess data
    train_datasets, eval_datasets, test_datasets = preprocess_cpo_data(train_raw_data, valid_raw_data, test_raw_data, pairs, tokenizer, shots_eval_dict, data_args, training_args, model_args, logger)
